...
#downloadPath = "D:\\resume\\Junaid Ahmed Resume\\Final\\GSA-Elibrary-Scrapping-master\\Files\\"

downloadPath = "C:\\Users\\Administrator\\Desktop\\UmerCode\\download\\" 
DB_URL = 'http://blackvoltrontechs.com/transviti/GSA_scrap'
startLetter = 'A'     # starting value is 'A'
startFrom = 0
...
def StartScrapping_internal(pageLetter,soup,link,startFrom=0):
    totalTime = 0
    avgTime = 0
...
def StartScrapping():
    ...
    for pageLetter in ascii_uppercase:
        ...
        if not shouldPass:
            ...
            resp = StartScrapping_internal(pageLetter,soup,link,startFrom)
            if resp==1:
                return 1
